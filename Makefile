# This Makefile is for the File::Next extension to perl.
#
...
#     ABSTRACT_FROM => q[Next.pm]
#     AUTHOR => q[Andy Lester <andy@petdance.com>]
#     NAME => q[File::Next]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[Next.pm]
#     clean => { FILES=>q[File-Next-*] }
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  Next.pm $(INST_MAN3DIR)/File::Next.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                File-Next' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            File-finding iterator' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>File-finding iterator</ABSTRACT>' >> $(DISTNAME).ppd
